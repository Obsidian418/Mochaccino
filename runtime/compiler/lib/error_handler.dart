...
class IssueTitle {
  ...
  static String unexpectedToken(Token token) => "Unexpected token '${token.lexeme}'";
  static String operationTypeError(String op, Type expectedType, Type givenType) => "Operation '$op' requires operand(s) to be [$expectedType] but [$givenType] found instead.";
  static String undefinedObject(String name) => "Mochaccino Object named '$name' not defined";
}
